...
#        cell  |  1c  |  0c   |  0c     
#          is  |------|-------|--------
#present here  |  1r  |  1r   |  1r  
#      i.e     |  1c  |  0c   |  0c      
#    side bar  |------|-------|--------
#       frame  |  0r  |  0r   |  0r     
#              |  1c  |  0c   |  0c      
        self.sidebar_frame.grid_rowconfigure(4, weight=1) #configure the 5th row
        ...
        self.entry = customtkinter.CTkEntry(self, placeholder_text="CTkEntry",justify="center")
        ...
        self.string_input_button.grid(row=2, column=0, padx=20, pady=(10,0))
        self.label_tab_2 = customtkinter.CTkLabel(self.tabview.tab("Tab 2"), text="CTkLabel on Tab 2")
        self.label_tab_2.grid(row=0, column=0, padx=20, pady=(10,10))
        self.combobox_2 = customtkinter.CTkComboBox(self.tabview.tab("Tab 2"),values=["option 1","option 2","option 3"])
        self.combobox_2.grid(row=1,column=0,padx=20,pady=0)
