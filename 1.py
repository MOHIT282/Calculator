...
def modes():
    ...
    if j== 0:
        ...
        entry.configure(fg_color="grey",text_color="#2e2d2d",border_color="#2e2d2d")
...
#buttons for frame 5
button_sin = customtkinter.CTkButton(frame_5,command=lambda:show("sin"),height=70,width=85,fg_color="#4d4c4c",hover_color="#30302f",text="sin",font=("Cascadia",36,"bold"))
button_sin.pack(side="left",padx=2,pady=4)

button_cos = customtkinter.CTkButton(frame_5,command=lambda:show("cos"),height=70,width=85,fg_color="#4d4c4c",hover_color="#30302f",text="cos",font=("Cascadia",36,"bold"))
...
button_back = customtkinter.CTkButton(frame_0,height=70,width=85,command=back,fg_color="#4d4c4c",hover_color="#30302f",text="<",font=("Cascadia",36,"bold"))
